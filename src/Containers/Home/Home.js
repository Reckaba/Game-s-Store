                ...
                <div className={styles.container}>
                    <div className={styles.left}>
                        ...
                        <div className={styles.buttons}>
                              ...
                              <a href="https://github.com/Reckaba" target="_blank"><button className={styles.cta} aria-label="View Repository">
                                <GitHubLogo className={styles.ctaSVG} />
                                GitHub
                              </button></a>
                              <a href="https://www.linkedin.com/in/aziz-abishov-a46768272/" target="_blank"><button className={`${styles.cta} ${styles.lastChild}`} aria-label="Open LinkedIn">
